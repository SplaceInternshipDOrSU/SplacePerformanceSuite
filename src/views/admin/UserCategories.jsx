...
import { categoryAdd ,messageClear, categories_get ,categoryDelete} from '../../store/Reducers/adminReducer';
...
const UserCategories = () => {
    ...
    const {categories,totalCategories,totalPages, loader, successMessage, errorMessage, loader_delete  } = useSelector(state=>state.admin)
  ...
  return (
    <div className=' pt-5'>
        <div className="flex lg:hidden justify-between items-center mb-5 p-4 bg-[#283046] rounded-md">
                <h1 className='text-text_color font-semibold text-lg text-slate-300'>Categories</h1>  
        ...
        <div className="flex flex-wrap w-full ">
            <div className="w-full lg:w-9/12">
                ...
                <div className="w-full pl-5">
                    <div className="bg-[#283046] rounded-md h-screen lg:h-auto px-3 py-6 lg:rounded-md text-slate-100">
                        <div className="flex justify-between items-center py-3">
                            <h1 className='text-text_color font-semibold text-xl uppercase'>Add Employee Category</h1>
                        ...
                        <form onSubmit={add_Category} className=''>
                            ...
                            <button disabled={loader ? true : false} className='bg-accent uppercase w-full hover:shadow-[#6ED601]/10 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3 font-bold mt-5'>
                                {
