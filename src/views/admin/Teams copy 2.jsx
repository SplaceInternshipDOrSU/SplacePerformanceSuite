...
const Teams = () => {
  ...
  const { loader_delete, loader_role, role, editError, editErrorMessage } =
  ...
  const supervisorSearch = (e) => {
    ...
    if (value) {
      let srchValue = allSupervisors.filter((c) =>
  ...
  const managerSearch = (e) => {
    ...
    if (value) {
      let srchValue = allManagers.filter((c) =>
        c.name.toLowerCase().includes(value.toLowerCase())
      );
  ...
  const randfSearch = (e) => {
    ...
    if (value) {
      let srchValue = allRandFs.filter((c) =>
        c.name.toLowerCase().includes(value.toLowerCase())
      );
  ...
  return (
    <div className=" pt-5">
      <div className="flex lg:hidden justify-between items-center mb-5 p-4 bg-[#283046] rounded-md">
        <h1 className="text-text_color font-semibold text-lg text-slate-100">
          EMPLOYEE ROLES
        </h1>
        <button
          onClick={() => setShow(true)}
          className="bg-accent shadow-lg hover:shadow-accent/50 px-4 py-2 cursor-pointer text-white rounded-md text-sm font-semibold"
        >
          ADD EMPLOYEE ROLE
        </button>
      </div>
      <div className="flex flex-wrap w-full ">
                  ...
                  {loader_delete ? (
                    ...
                    teams.map((team, i) => (
                      <tr key={i}>
                            ...
                            {showEmail === i ? (
                              <div className="flex items-center">
                                <span
                                  ...
                                  data-tooltip-content="Click to view Name"
                                >
                              ...
                              <span
                                data-tooltip-id="my-tooltip"
                                data-tooltip-content="Click to view Email"
                              >
                        ...
                        <td className="py-2 px-4 font-medium max-w-[220px]">
                          <button
                            className="flex justify-center gap-1 bg-accent px-2 py-1 rounded-xs uppercase font-bold text-center items-center hover:bg-white hover:text-accent shadow-2xl hover:shadow-accent"
                            onClick={() => handleOpenModal(i)}
                          >
                            View all{" "}
                            <RiTeamFill className="mb-[3px]" size={16} />
                          </button>
                        </td>
                        ...
                        {activeTeamIndex === i && (
                          <td
                            colSpan="6"
                            className="fixed inset-0 z-[99999] bg-gray-500/20 flex items-center justify-center"
                          >
                    ...
                    <tr>
                      <td
                        colSpan="6"
                        className="px-4 text-center font-medium py-5"
                      >
                        No Team/s Available
                      </td>
                    </tr>
        ...
        {isEditModalOpen && (
          <div className="fixed inset-0 flex items-center justify-center bg-[rgba(0,0,0,0.5)] z-[99999999]">
            <div className="bg-white rounded-lg p-6 shadow-lg w-[500px] h-[400px]">
              ...
              <p className="mb-1">
                Role Currently Editing:{" "}
                <span className="font-bold text-accent">
                  {selectedRoleName}
                </span>
              </p>
              {loader_role?.role ? (
                <div className="w-full h-[220px] flex justify-center items-center text-center ">
                  Fetching Role Data...
                </div>
              ) : (
                <div className="w-full h-[190px]">
                  <div className="">
                    {editError ? (
                      <div className="w-full flex justify-between items-center bg-red-500 px-2 rounded py-2 font-bold text-slate-100">
                        {editErrorMessage} <FaExclamationCircle />
                      </div>
                    ) : (
                  ...
                  <div className="flex flex-col w-full gap-1 mb-3">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setStateEdit({ ...stateEdit, name: e.target.value })
                      }
                      id="name"
                      name="name"
                      className="px-4 py-2 focus:border-accent outline-none border-2 border-slate-700 rounded-md text-slate-600"
                      type="text"
        ...
        <div
          className={`w-[320px] lg:w-3/12 lg:relative lg:right-0 fixed ${
          ...
          <div className="w-full pl-5">
            <div className="bg-[#283046] rounded-md h-screen lg:h-auto px-6 py-6 lg:rounded-md text-slate-100">
              <div className="flex justify-between items-center py-3">
                <h1 className="text-text_color font-semibold text-xl uppercase">
                  Add New Team
                </h1>
                <div
                ...
                >
                  <IoClose className="text-text_color" size={25} color="red" />
                </div>
              </div>
              <form onSubmit={add_Team} className="">
                <div className="flex flex-col w-full gap-1 mb-3">
                  ...
                  <input
                    ...
                    id="name"
                    name="name"
                    className="px-4 py-2 focus:border-accent outline-none bg-[#283046] border border-slate-700 rounded-md text-white"
                    type="text"
                ...
                <div className="mt-7  w-full ">
                  ...
                  <div className="w-full ">
                    ...
                    <input
                      ...
                      className="w-full bg-transparent px-4 py-1 focus:border-accent outline-none border-2 border-slate-500 rounded-md text-slate-200"
                      type="text"
                      ...
                      <div className="fixed inset-0 z-50 bg-gray-500/50 flex items-center justify-center">
                        <div className="bg-white rounded-lg w-[400px] h-[300px] max-w-md p-4 shadow-xl text-slate-800">
                          ...
                          <input
                            ...
                            value={searchValueSv}
                            className="mb-3 w-full px-4 py-1 border-b-2 border-slate-700 bg-transparent outline-none text-slate-800"
                            type="text"
                            placeholder="Supervisor"
                            name="role"
                            id="role"
                  ...
                  <div className="w-full pt-3">
                    <div className="font-bold h-3 text-gray-500 text-xs uppercase mb-2">
                      ASSIGN A Rank and File Employees
                    </div>
                    ...
                    {showRandF && (
                      <div className="fixed inset-0 z-50 bg-gray-500/50 flex items-center justify-center ">
                        <div className="bg-white rounded-lg w-[400px] h-[300px] max-w-md p-4 shadow-xl text-slate-800">
                          <div className="flex justify-between items-center mb-4">
                            <h2 className="font-bold text-lg">
                              Select Rank and File Employees{" "}
                            </h2>
                            <button
                              type="button"
                          ...
                          <div className="max-h-48 overflow-y-auto">
                            {allRandFs.map((f) => {
                              const isChecked = selectedRandFs.some(
                                (item) => item._id === f._id
                              );
                              return (
                                <label
                ...
                <button
                  disabled={loader_team ? true : false}
                  className="bg-accent uppercase w-full hover:shadow-accent/20 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3 font-bold mt-5"
                >
                  {loader_team ? (
                    <PropagateLoader color="#fff" cssOverride={overRideStyle} />
                  ) : (
                    <div className="flex w-full justify-center items-start gap-1">
                      ADD TEAM <RiTeamFill size={20} className="" />
                    </div>
                  )}
                </button>
              </form>
