...
import { roleAdd ,messageClear, roles_get ,categoryDelete} from '../../store/Reducers/adminReducer';
...
const UserRoles = () => {
    ...
    const {roles,totalRoles,totalPages, loader, successMessage, errorMessage, loader_delete  } = useSelector(state=>state.admin)
